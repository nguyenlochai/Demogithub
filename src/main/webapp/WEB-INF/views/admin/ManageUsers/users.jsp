		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div>
						<a class=" haicr " href="/Diamonshopp/admin/userRegister">Quản
							lý khách hàng đã đăng ký</a>
					</div>
					<div>
						<a class=" haicq " href="/Diamonshopp/admin/userBills">Quản lý
							khách hàng đã thanh toán</a>
					</div>
